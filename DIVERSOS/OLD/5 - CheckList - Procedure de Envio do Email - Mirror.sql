...
--	Alterar o PROFILE e o E-MAIL para os necessários:
		...
		@recipients = 'E-mail@provedor.com', 
...
BEGIN
	...
	***********************************************************************************************************************************/
	...
	SET @UtilizacaoArqWrites_Table = 
			'<table cellspacing="2" cellpadding="5" border="3">'    
			+	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Nome Database</font></th>
					<th width="100" bgcolor=#0B0B61><font color=white>File ID</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>io_stall_write_ms</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>num_of_writes</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>avg_write_stall_ms</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/
	...
	SET @UtilizacaoArqReads_Table = 
			...
			+	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Nome Database</font></th>
					<th width="100" bgcolor=#0B0B61><font color=white>File ID</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>io_stall_read_ms</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>num_of_reads</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>avg_read_stall_ms</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/
    ...
    SET @DatabaseSemBackup_Table = REPLACE( REPLACE( REPLACE(@DatabaseSemBackup_Table, '&lt;', '<'), '&gt;', '>'), '<td>', '<td align=center>')
	...
	***********************************************************************************************************************************/ 
	...
	SET @JobsRunning_Table = 
            ...
            +	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Nome Job</font></th>
					<th width="100" bgcolor=#0B0B61><font color=white>Data Início</font></th> 
	...
	***********************************************************************************************************************************/
	...
	SET @QueriesDemoradas_Table = 
			'<table cellspacing="2" cellpadding="5" border="3">'    
            +	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Prefixo Query (150 caracteres iniciais)</font></th>
					<th width="70" bgcolor=#0B0B61><font color=white>Qtd</font></th>
					<th width="70" bgcolor=#0B0B61><font color=white>Total (s)</font></th>    
					<th width="70" bgcolor=#0B0B61><font color=white>Média (s)</font></th>
					<th width="70" bgcolor=#0B0B61><font color=white>Menor (s)</font></th>       
					<th width="70" bgcolor=#0B0B61><font color=white>Maior (s)</font></th>     
					<th width="70" bgcolor=#0B0B61><font color=white>Writes</font></th> 
					<th width="70" bgcolor=#0B0B61><font color=white>CPU</font></th>
					<th width="70" bgcolor=#0B0B61><font color=white>Reads</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/
	...
	SET @Contadores_Table = 
            ...
            +	'<tr>
					...
					<th width="120" bgcolor=#0B0B61><font color=white>Qtd Queries Lentas</font></th>
					<th width="120" bgcolor=#0B0B61><font color=white>Reads Queries Lentas</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/ 
	...
	SET @ConexoesAbertas_Table = CAST( (    
		SELECT td =				  [login_name]		+ 
					'</td><td>' + [session_count]	+	'</td>'                                     
		FROM (	
				SELECT	TOP 10
						ISNULL([login_name], '-')			AS [login_name], 
						CAST([session_count] AS VARCHAR)	AS [session_count]
				FROM [dbo].[CheckList_Conexao_Aberta]
				ORDER BY CAST([session_count] AS INT) DESC
				
			  ) AS D ORDER BY CAST([session_count] AS INT) DESC
		FOR XML PATH( 'tr' ), TYPE ) AS VARCHAR(MAX) 
	)   
	...
	SET @ConexoesAbertas_Table = 
			'<table cellspacing="2" cellpadding="5" border="3">'    
            +	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Login Name</font></th> 
	...
	***********************************************************************************************************************************/
	...
	SET @MirrorHeader = @MirrorHeader + '<br/> TOP 10 - Situação das Databases do Mirror <br/>' 
	...
	***********************************************************************************************************************************/
	...
	SET @Alerta_Sem_Clear_Table =
			'<table cellspacing="2" cellpadding="5" border="3">'    
            +	'<tr>
					<th width="210" bgcolor=#0B0B61><font color=white>Nome Alerta</font></th>
					<th width="400" bgcolor=#0B0B61><font color=white>Mensagem</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>Data</font></th>
					<th width="150" bgcolor=#0B0B61><font color=white>Duração</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/
	...
	SET @LoginFailed_Table = CAST( (    
		...
		FROM (
			  ...
			  ) AS D ORDER BY CAST(REPLACE([Qt_Erro], '-', 0) AS INT) DESC
		FOR XML PATH( 'tr' ), TYPE ) AS VARCHAR(MAX) 
	)
	      
	SET @LoginFailed_Table = REPLACE( REPLACE( REPLACE(@LoginFailed_Table, '&lt;', '<'), '&gt;', '>'), '<td>', '<td align=center>')
	    
	SET @LoginFailed_Table = 
			'<table cellspacing="2" cellpadding="5" border="3">'    
			+	'<tr>
					<th width="200" bgcolor=#0B0B61><font color=white>Usuário</font></th>
					<th width="100" bgcolor=#0B0B61><font color=white>Qtd Erros</font></th>
				</tr>'    
	...
	***********************************************************************************************************************************/
	...
	IF ( @LoginFailed_Table IS NOT NULL )
		SELECT @EmailBody = @EmailBody + @LoginFailed_Header + @emptybody2 + @LoginFailed_Table + @emptybody2					-- Error Log SQL
...
--EXEC [dbo].[stpCheckList_Databases_Mirror]			-- Mirror
